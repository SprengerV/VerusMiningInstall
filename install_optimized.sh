...
cd       /usr/src                         &&
announce 'Downloading LLVM install...   ' &&
wget     https://apt.llvm.org/llvm.sh     &&
announce 'Changing permissions...       ' &&
sudo     chmod +x llvm.sh                 &&
announce 'Installing LLVM...            ' &&
sudo     /usr/src/llvm.sh 16              &&
